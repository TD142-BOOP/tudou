...
public class QuestionBankController {
    ...
    @PostMapping("/update")
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateQuestionBank(@RequestBody com.tudou.tudoumianshi.model.dto.questionBank.QuestionBankUpdateRequest questionBankUpdateRequest) {
